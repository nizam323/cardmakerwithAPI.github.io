let usersCardsData = [
    { 
        "login": "nizam-ud-din", 
        "avatar_url": "https://lh3.googleusercontent.com/ogw/AF2bZyjxyaP2XD0ZqSXSH_We-_VexoSu6fPxHovwEpqH5rP_SQ=s64-c-mo", 
    },
    {
        "login": "mojombo",
        "id": 1,
...
usersCardsData.map(
    (items) => {
        ...
        cardImg.setAttribute("src", items.avatar_url); 
        cardName.classList.add("name");
        cardH1.innerText = items.login; 
        cardProfession.classList.add("name");
        cardH2.innerText = "web developer "; 
...
function cardMaker() {
    ...
    parentCard.classList.add("parent-card");
    cardImg.classList.add("card-img");
    cardImg.setAttribute("src", userProfileInput);// userProfileInput || 
    cardName.classList.add("name");
    cardH1.innerText = userNameInput;//userNameInput || 
    cardProfession.classList.add("name");
    cardH2.innerText = userProfessionInput;//userProfessionInput || 
    cardBtn.classList.add("card-btn");
    cardBtn.innerText = "review profile";
    ...
    let userCard = {
        name: userNameInput,
        profession: userProfessionInput,
        profileUrl: userProfileInput,
    };
    usersCardsData.push(userCard);
    console.clear();
